...
1. **Read `.claude/commands/web-standards.md` now.** Do not write any code until you have read this file. Confirm you have read it before proceeding.
2. **Read `.claude/commands/frontend-design.md` now.** Do not write any frontend code until you have read this file. Confirm you have read it before proceeding.
3. If you cannot find these files, stop and tell the user. Do not proceed without reading them.
